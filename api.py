...
def home():
    ...
    sumMinChars = int(request.form.get("minuchars")) + int(request.form.get("minlchars")) + int(request.form.get("minnumbers")) +int(request.form.get("minschars"))
    infoMsg = ""
    if sumMinChars > int(request.form.get("maxlen")):
        # Display info message
        infoMsg = "Minimum chars parameters exceed maximum length. Automatically set maximum length to " + str(sumMinChars)
